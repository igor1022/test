...
class ArrayMerge
{
    ...
    private function createRandomArray(array $data, string $array_alength)
    {
        $randomArray = [];
...
$arrayToCombine = new ArrayMerge();
$arrayCombined = iterator_to_array($arrayToCombine->combine_array());
